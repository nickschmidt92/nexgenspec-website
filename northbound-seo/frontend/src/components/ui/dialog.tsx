  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'border border-border bg-surface rounded-lg p-6 shadow-xl font-mono',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 text-dim hover:text-text transition-colors">
        <X className="h-4 w-4" />
